...
Packstack is a OpenStack deployment tool intended to **install Proof of Concept small environments in a quick and easy way using RDO distribution on CentOS Stream hosts**. Production features as High Availability, OpenStack upgrades or other day-2 operations are out of the scope of Packstack. For these cases you can rely in other recommended tools as [TripleO](https://tripleo-docs.readthedocs.io/en/latest/index.html), [Kolla](https://docs.openstack.org/kolla/latest/) or [Openstack-Ansible](https://docs.openstack.org/openstack-ansible/latest/).
