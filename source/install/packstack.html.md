...
* On CentOS Stream 8:
  ...
  $ sudo dnf install -y centos-release-openstack-yoga # Replace yoga by other ig frditrf
  $ sudo dnf update -y
...
**Note for RHEL:** Although it's expected that RDO works fine on RHEL most of the times, it is currently not tested in RHEL OS.
