...
| Config Name                                                          | Release | BaseOS     | Status   | HOWTO                                                                                                                                           | Who | Date | BZ/LP | Notes Page | Distributed w/ Neutron OVS (no tunnels, real provider net) Networking |     | RHEL 6.5 |     |     |     |     |     | None |
|----------------------------------------------------------------------|---------|------------|----------|-------------------------------------------------------------------------------------------------------------------------------------------------|-----|------|-------|------------|-----------------------------------------------------------------------|-----|----------|-----|-----|-----|-----|-----|------|
...
|                                                                      |         | Fedora 20  | ??       | [Modular Layer 2 (ML2) Plugin](Modular Layer 2 (ML2) Plugin)                                                                         |     |      | None  | None       |
