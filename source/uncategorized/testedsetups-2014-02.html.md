...
| Distributed w/ Neutron OVS (VXLAN) Networking using foreman          |         | RHEL 6.5   |          | [Using VXLAN Tenant Networks](Using VXLAN Tenant Networks)                                                                           |     |      | None  |            |
|                                                                      |         | Fedora 20  | ??       |                                                                                                                                                 |     |      | None  | None       |
...
| 3 Node install with Neutron              | RDO Icehouse | RHEL 6.5   | <span style="background:#00ff00">Good</span> | [ 3 Node install with Neutron](Deploying_RDO_Using_Foreman#Neutron_with_Networker_Node)                  | ohochman | 2014 -02 |       | | None     |
|                                          |              | CentOS 6.5 | ??                                           | [ 3 Node install with Neutron](Deploying_RDO_Using_Foreman#Neutron_with_Networker_Node)                  |          |          | None  | None       |
| 4 node (Compute x2) install with Neutron | RDO Icehouse | RHEL 6.5   |                                              | [ 4 Node install (Compute x2) with Neutron](Deploying_RDO_Using_Foreman#Neutron_with_Networker_Node)     | ohochman | 2014 -02 | None  | None       |
