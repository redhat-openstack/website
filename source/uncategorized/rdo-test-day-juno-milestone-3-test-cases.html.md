...
| All-in-one Nova tests            | RDO Juno | RHEL7     |                                              |                                                                                                                                                   | gszasz, stoner |      | Packstack + nova sanity                                  |            |
| 2.node (nova-network) Nova tests | RDO Juno | RHEL7     |                                              |                                                                                                                                                   | gszasz         |      | Packstack + nova live migration (block / shared storage) |            |
| 2.node Nova tests                | RDO Juno | RHEL7     |                                              |                                                                                                                                                   | gszasz, stoner |      | Packstack + nova live migration (block / shared storage) |            |
