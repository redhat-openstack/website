...
| Multinode (nova network) Nova tests | RDO Juno | RHEL7     |                                              |                                                                                                                                                   | gszasz   |      | Packstack + nova live migration (block / shared storage) |            |
| Multinode (neutron) Nova tests      | RDO Juno | RHEL7     |                                              |                                                                                                                                                   | gszasz   |      | Packstack + nova live migration (block / shared storage) |            |
