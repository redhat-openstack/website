...
If you are installing OpenStack on Fedora 20 or later, you **do not** need to enable any additional repositories. The RDO OpenStack packages and all dependencies are included in the Fedora repositories.
