...
Instack is used to create the undercloud. This can be either done on a fully virtualised environment or with bare metal. Follow the steps described in [Deploying_an_RDO_Undercloud_with_Instack](deploying an RDO Undercloud) to create the undercloud for this installation.
