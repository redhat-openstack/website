...
| semi destributed component/ AIO+component on different server |         | CentOS 6.5  | ??     | [Quickstart](Quickstart) but use a remote system for either CONFIG_CINDER_HOST , CONFIG_GLANCE_HOST or CONFIG_SWIFT_STORAGE_HOSTS  | ??  | ??   | None  | None       |
|                                                               |         | Fedora 19   | ??     | [Quickstart](Quickstart) but use a remote system for either CONFIG_CINDER_HOST , CONFIG_GLANCE_HOST or CONFIG_SWIFT_STORAGE_HOSTS  | ??  | ??   | None  | None       |
|                                                               |         | Fedora 20   | ??     | [Quickstart](Quickstart) but use a remote system for either CONFIG_CINDER_HOST , CONFIG_GLANCE_HOST or CONFIG_SWIFT_STORAGE_HOSTS  | ??  | ??   | None  | None       |
|                                                               |         | RHEL 6.5    | ??     | [Quickstart](Quickstart) but use a remote system for either CONFIG_CINDER_HOST , CONFIG_GLANCE_HOST or CONFIG_SWIFT_STORAGE_HOSTS  | ??  | ??   | None  | None       |
| Full Distribution/ Different components on each server        |         | CentOS 6.5  | ??     | [Quickstart](Quickstart) but use a remote system for each of CONFIG_CINDER_HOST , CONFIG_GLANCE_HOST or CONFIG_SWIFT_STORAGE_HOSTS | ??  | ??   | None  | None       |
|                                                               |         | Fedora 19   | ??     | [Quickstart](Quickstart) but use a remote system for each of CONFIG_CINDER_HOST , CONFIG_GLANCE_HOST or CONFIG_SWIFT_STORAGE_HOSTS | ??  | ??   | None  | None       |
|                                                               |         | Fedora 20   | ??     | [Quickstart](Quickstart) but use a remote system for each of CONFIG_CINDER_HOST , CONFIG_GLANCE_HOST or CONFIG_SWIFT_STORAGE_HOSTS | ??  | ??   | None  | None       |
|                                                               |         | RHEL 6.5    | ??     | [Quickstart](Quickstart) but use a remote system for each of CONFIG_CINDER_HOST , CONFIG_GLANCE_HOST or CONFIG_SWIFT_STORAGE_HOSTS | ??  | ??   | None  | None       |
