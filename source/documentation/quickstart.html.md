...
If you just want to try it out without installing anything, check out [TryStack](http://trystack.org). And if you'd like to try the development version of OpenStack ("Icehouse"), see [QuickstartLatest](QuickstartLatest).
