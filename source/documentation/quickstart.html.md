...
*Looking for Icehouse? Use rdo.fedorapeople.org/openstack-icehouse/rdo-release-icehouse.rpm instead. Looking for an older version? See <http://rdo.fedorapeople.org/> for the full listing.*
