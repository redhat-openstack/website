...
If you just want to try it out without installing anything, check out [TryStack](http://trystack.org). If you'd like to try the development version of OpenStack ("Icehouse"), see [RDO_test_day_January_2014](RDO_test_day_January_2014).
