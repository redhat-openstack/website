...
* [Workarounds](/testday/queens/workarounds3)
...
* Check for any [workarounds](/testday/queens/workarounds3) required for your platform before the main installation.
...
1. Go through the scenario as though you were a beginner, just following the instructions. (Check the [workarounds](/testday/queens/workarounds3) page for problems that others may have encountered and resolved.)
...
Once you have completed the tests, add your results to the table on the [test matrix](/testday/tests) page, following the examples already there. Be sure to check the [workarounds](/testday/queens/workarounds3) page for things that may have already have fixes or workarounds.
