...
We will be holding a RDO test day on October 27th and 28th, 2017.
...
* [Workarounds](/testday/queens/workarounds1)
...
* Check for any [workarounds](/testday/queens/workarounds1) required for your platform before the main installation.
...
1. Go through the scenario as though you were a beginner, just following the instructions. (Check the [workarounds](/testday/queens/workarounds1) page for problems that others may have encountered and resolved.)
...
Once you have completed the tests, add your results to the table on the [test matrix](/testday/tests) page, following the examples already there. Be sure to check the [workarounds](/testday/queens/workarounds1) page for things that may have already have fixes or workarounds.
