...
For each OpenStack release following set of pipelines is proceeded:
...
This pipelines run in parallel and are composed of different jobs.
...
packages:
  * The repo is published using RDO Trunk servers in [https://trunk.rdoproject.org/centos9-\<openstack_version\>/current/delorean.repo](https://trunk.rdoproject.org/centos9-master/current/delorean.repo)
